...
class TestJavaExamples : StringSpec(
    {
        ...
        examples.java.receiver.equalwithkotlin.Correct::class.java.also {
            "${it.testName()}" { it.test() }
        }
        examples.java.noreceiver.fixedparameterlistof.Correct::class.java.also {
            "${it.testName()}" { it.test() }
        }
        ...
        examples.java.noreceiver.returnslist.Correct::class.java.also {
            "${it.testName()}" { it.test() }
        }
        examples.java.noreceiver.returnsiterator.Correct::class.java.also {
            "${it.testName()}" { it.test() }
        }
        examples.java.noreceiver.returnsstream.Correct::class.java.also {
            "${it.testName()}" { it.test() }
        }
        ...
        examples.java.receiver.firstequalssecond.Correct::class.java.also {
            "${it.testName()}" { it.test() }
        }
